...
const MainPage = ({ setActiveSection }) => {
  ...
  const cardsData = [
  {
    ...
    description:
      "Specialized in developing high-performance, responsive, and scalable web applications with React, TypeScript, Tailwind CSS, JavaScript, HTML, and CSS, with a strong focus on clean architecture and exceptional user experience.",
  },
  {
    title: "Software Engineer",
    description:
      "Experienced in translating complex requirements into scalable and maintainable software solutions, combining strong problem-solving, software architecture, and modern development practices.",
  },
];
      ...
      >
        ...
        <div className="w-full md:w-1/2 mb-10 md:mb-0 text-center md:text-left z-10">
          <h1 className="text-3xl sm:text-5xl font-bold mb-4 text-mysecondary dark:text-white">
            ...
            <span className="text-myprimary dark:text-blue-400">Hanan</span>
          </h1>
          <p className="text-lg text-[#43495B] mb-5 dark:text-white">
          An advanced front-end developer with a passion for building high-performing, beautiful, and scalable web experiences. I specialize in{" "}
            <span className="text-myprimary">advanced front-end</span>  and responsive design..
          </p>
...
<section
  ...
  <div className="w-full lg:w-1/2 flex justify-center mb-8 lg:mb-0">
    <img
      src={theme === "dark" ? "/hanin-portfolio/assets/image/tech1.jpg" : "/hanin-portfolio/assets/image/tech.png"}
      alt="about"
  ...
  <div className="w-full lg:w-1/2 text-center lg:text-left">
    ...
    <p className="text-lg text-mysecondary dark:text-white mb-6">
      I'm Hanan, a front-end developer who enjoys crafting clean interfaces and smooth user experiences. I specialize in modern web technologies and love turning ideas into interactive websites.
    </p>
      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start text-center md:text-left mb-8 gap-4 flex-wrap">
          <h2 className="text-[30px] md:text-[40px] max-w-99 font-semibold text-mysecondary dark:text-white">
            My Creative Works ,Some <span className="text-myprimary">Projects</span>
          </h2>
          <Button
            href="https://github.com/Hanannoman"
            target="_blank"
            label="View GitHub"
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-12">
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-1/2 flex flex-col gap-4">
              <ContactMethod icon={FaPhoneAlt} title="Call Me" info="0935581531" />
              <ContactMethod icon={FaEnvelope} title="Email Me" info="hanannoman392003@gmail.com" />
              <ContactMethod icon={FaMapMarkerAlt} title="Address" info="Banias,Syria" />
            </div>
